...
var ground_max_speed = 200
var air_max_speed = 500

var swing_point = null
var swing_radius = null

@onready var camera_3d: Camera3D = $Camera3D
@onready var hook_ray_cast: RayCast3D = $Camera3D/HookRayCast
...
func _physics_process(delta: float) -> void:
	...
	var motion_2d = Vector2(motion.x, motion.z).rotated(camera_3d.rotation.y)
	...
	motion_2d = motion_2d.rotated(-camera_3d.rotation.y)
